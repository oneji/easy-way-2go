...
@section('content')
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.bas.approve', [$baRequest->id]) }}" method="POST" id="approveBaRequestForm" class="form-horizontal custom-validation" novalidate>
                        @csrf
        
                        <div class="form-group">
                            <label for="password">Email</label>
                            <input type="email" placeholder="Введите пароль" name="email" class="form-control" required>
                        </div>
                        <div class="form-group">
