<div class="modal fade edit-order-status-modal" tabindex="-1" role="dialog" aria-labelledby="editPaymentStatusModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">{{ __('pages.orderStatuses.editModalLabel') }}</h5>
